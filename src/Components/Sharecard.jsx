...
const Sharecard = () => {
  return (
    <StyledWrapper>
      <div className="main">
        <div className="card">
          <a href="https://www.instagram.com/webczarsolutions/#"><svg fillRule="nonzero" height="30px" width="30px" viewBox="0,0,256,256" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" className="instagram">
        ...
        <div className="card">
          <a href='https://github.com/Webczar-solutions'>
        ...
        <div className="card">
          <a href="https://www.reddit.com/user/VegetableAffect5009/"><svg xmlSpace="preserve" viewBox="0 0 256 256" height={30} width={30} version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" className="reddit">
            <defs />
        ...
        <p className="text">CONNECT<br /><br />WITH OUR<br /><br />SOCIAL PROFILES</p>
