...
export default function ClientsPage () {
    ...
    const logos = [
      { name: "Chandigarh club LTD", img: "/Images/Clients-page/client-1-Photoroom.png" },
      { name: "investors clinic", img: "/Images/Clients-page/client-2-Photoroom.png" },
      { name: "Clifton valley", img: "/Images/Clients-page/client-3-Photoroom.png" },
      { name: "chester hills", img: "/Images/Clients-page/client-4-Photoroom.png" },
      { name: "KBD", img: "/Images/Clients-page/client-5-Photoroom.png" },
      { name: "jubilee group", img: "/Images/Clients-page/client-6-Photoroom.png" },
      { name: "psp group", img: "/Images/Clients-page/client-7-Photoroom.png" },
      { name: "subhash mangat & group", img: "/Images/Clients-page/client-8-Photoroom.png" },
      { name: "subhash mangat", img: "/Images/Clients-page/client-9-Photoroom.png" },
      { name: "Mindlabz", img: "/Images/Clients-page/client-10-Photoroom.png" },
      { name: "ashoka textiles", img: "/Images/Clients-page/client-11-Photoroom.png" },
...
<div className="  flex flex-col items-center justify-center min-h-screen text-center px-6">
  ...
  <div className="w-full lg:w-1/2 max-w-7xl mx-auto text-center lg:text-center mb-12 lg:mb-0">
    ...
    <p className="text-base lg:text-lg px-4 sm:px-12 lg:px-24 text-gray-300">
      Our collaborations don’t just launch products — they fuel long-term business growth.
      Every project we touch is driven by data, creativity, and results that matter.
    </p>
  </div>
  ...
  <div className="w-full lg:w-1/2 flex flex-col gap-10 lg:gap-12 px-4 sm:px-8 ">
    {/* Revenue */}
    <div>
      <h2 className="text-2xl lg:text-4xl text-[#006AFE] mb-1">Revenue Empowered</h2>
      <div className="flex items-end gap-2">
        <h2 className="text-white text-5xl lg:text-[5rem] font-bold">50M</h2>
    ...
    {/* Reach */}
    <div>
      <h2 className="text-2xl lg:text-4xl text-[#006AFE] mb-1">Organic Reach Achieved</h2>
      <div className="flex items-end gap-2">
        <h2 className="text-white text-5xl lg:text-[5rem] font-bold">7M+</h2>
    ...
    {/* Projects */}
    <div>
      <h2 className="text-2xl lg:text-4xl text-[#006AFE] mb-1">Solutions Delivered</h2>
      <div className="flex items-end gap-2">
        <h2 className="text-white text-5xl lg:text-[5rem] font-bold">250+</h2>
